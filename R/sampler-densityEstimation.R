...
#'
#' @export
Sampler.DensityEstimation <- function(burnin, niter, thin, data, W, params, options = NULL, display_progress = TRUE, seed = NULL) {
  ...
  if (type == "no_rjmcmc") {
    output <- SPMIX:::runSpatialSampler(burnin, niter, thin, data_in, W_in, params_in, list(), FALSE, display_progress, seed)
  } else if (type == "rjmcmc") {
