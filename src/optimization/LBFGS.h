...
public:
    ...
    inline int minimize(Foo& f, Vector& x, Scalar& fx)
    {
        ...
        for (;;)
        {
            ...
            std::cout << "grad: " << m_grad.transpose() << std::endl;
            std::cout << "||grad|| = " << m_gnorm << std::endl << std::endl;*/
            ...
            std::cout << "f(x) = " << fx << std::endl;
            std::cout << "grad: " << m_grad.transpose() << std::endl;
            std::cout << "||grad|| = " << m_gnorm << std::endl;*/
            ...
            /*std::cout << "x - m_xp = " << (x - m_xp).transpose() << std::endl;
    ...
    Matrix final_ihess()
    {
        m_bfgs.compute_H(m_grad.size(), m_ihess);
        return m_ihess;
    }
